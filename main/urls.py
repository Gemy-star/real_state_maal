...
urlpatterns = [
    ...
    path('jobrequest/<int:pk>/', JobRequestDetailView.as_view(), name='jobrequest-detail'),
    path('jobrequest/<int:pk>/delete/', JobRequestDeleteView.as_view(), name='jobrequest-delete'),
